...
2. `docs/architecture/repo-structure.md` 읽기 — 저장소 경계와 구현 기준 파악
3. `docs/product/screen-flow.md` 읽기 — 현재 구현 현황 파악
4. `docs/progress/decisions.md` 읽기 — 기존 결정 키 확인
4. 새 흐름 설계:
   - 역할별 분기 (팀장/팀원/옵저버)
   - 진입 조건, 이탈 조건
   - API 호출 시점
...
5. `docs/product/screen-flow.md` 또는 `docs/architecture/` 업데이트
6. 주요 설계 결정이 있으면:
