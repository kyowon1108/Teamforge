...
| 2026-04-09 | `260409_02-oauth-brand-buttons.md` | OAuth 3종(Google/GitHub/Kakao) 버튼 브랜드 가이드 재설계, OAuth 시맨틱 토큰 7개 신설, Kakao 콘솔 점검(비즈앱 권한 한계 재확인), Login Figma 재캡처, KF-041~043 |
