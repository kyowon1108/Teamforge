...
| 저장소 구조 | `docs/architecture/repo-structure.md` | 전체 폴더 구조, 경계, 문서 우선순위 |
| 워크스페이스 부트스트랩 | `docs/architecture/workspace-bootstrap.md` | 실제 실행 시작점, 첫 명령, 앱 경계 |
...
| 리서치 아카이브 | `docs/research/` | 배경 자료 보관, 구현 기준 아님 |
...
| 에이전트 | 소유 경로 | 역할 |
|---------|---------|------|
| `tf-flow` | docs/product/, docs/architecture/, docs/adr/ | 화면/UX/아키텍처 흐름 설계 |
...
- TS 공유 설정: `packages/config/typescript/`
